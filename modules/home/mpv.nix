...
in
{
  programs.mpv = {
    ...
    config = {
      ...
      hwdec = lib.mkIf (system == "x86_64-linux") "vaapi";
      ...
      #################################################
      #~ audio output
      ao = lib.mkIf (system == "x86_64-linux") "pipewire";
    ...
    scriptOpts.subs2srs = {
      ...
      deck_name = "English::00: Collection::subs2srs";

      #~ Model names are listed in `Tools -> Manage note types` menu in Anki.
      model_name = "English sentences";
      ...
      autoclip_custom_args = "${home}/.local/bin/trans-subs %MPV_PRIMARY%";
      ...
      secondary_sub_lang = "eng,en,tr,trTR";
      #secondary_sub_lang=
